...
(function(){
  var stringify, ref$, filter, map, foldl, each, sortBy, reverse, uniqueBy, plus, minus, times, div, fromHex, $toHex, get, post, Web3, Tx, BN, hdkey, bip39, ERC20BridgeToken, jsonParse, deadline, decode, encode, Common, vlxToEth, ethToVlx, sha3, isChecksumAddress, isAddress, toVelasAddress, toEthAddress, isValidAddress, getEthereumFullpairByIndex, makeQuery, getTransactionInfo, getGasEstimate, calcFee, getKeys, round, toHex, transformTx, getInternalTransactions, getExternalTransactions, up, getTransactions, getContractTransactions, getDec, calcGasPrice, tryGetLatest, getNonce, getContractInstance, createTransaction, checkDecodedData, pushTx, checkTxStatus, getTotalReceived, getUnconfirmedBalance, getWeb3, getBalance, getEthBalance, getSyncStatus, getPeerCount, getMarketHistoryPrices, toString$ = {}.toString, out$ = typeof exports != 'undefined' && exports || this;
  ...
  out$.createTransaction = createTransaction = curry$(function(config, cb){
    var network, account, recipient, amount, amountFee, data, feeType, txType, gasPrice, gas, swap, dec, privateKey;
