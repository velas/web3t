...
(function(){
  var moment, ref$, map, foldl, any, each, find, sum, filter, head, values, join, reverse, uniqueBy, get, post, plus, minus, div, times, BitcoinLib, bip39, jsonParse, deadline, decode, validate, segwitAddress, segwitAddress2, getBitcoinFullpairByIndex, findMax, getEnough, calcFeePerByte, calcDynamicFee, getCalcFeeFunc, calcFeePrivate, calcFeeInstantx, calcFee, getKeys, extend, getDec, addAmount, getOutputs, parseRateString, extractVal, parseResult, getDepositAddressInfo, getDepositAddressFromList, getDepositAddress, addOutputsPrivate, addOutputs, getError, createTransaction, pushTx, getTotalReceived, getUnconfirmedBalance, getBalance, transformIn, transformOut, transformTx, getApiUrl, checkTxStatus, getTransactions, prepareRawTxs, prepareTxs, isValidAddress, slice$ = [].slice, toString$ = {}.toString, out$ = typeof exports != 'undefined' && exports || this;
