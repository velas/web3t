...
(function(){
  var moment, ref$, map, foldl, any, each, find, sum, filter, head, values, join, get, post, plus, minus, div, times, BitcoinLib, bip39, jsonParse, deadline, decode, segwitAddress, segwitAddress2, getBitcoinFullpairByIndex, findMax, getEnough, calcFeePerByte, calcDynamicFee, getCalcFeeFunc, calcFeePrivate, calcFeeInstantx, calcFee, getKeys, extend, getDec, addValue, getOutputs, parseRateString, extractVal, parseResult, getDepositAddressInfo, getDepositAddressFromList, getDepositAddress, addOutputsPrivate, addOutputs, getError, createTransaction, pushTx, getTotalReceived, getUnconfirmedBalance, getBalance, incomingVout, outcomingVouts, transformIn, transformOut, transformTx, getApiUrl, checkTxStatus, getTransactions, slice$ = [].slice, toString$ = {}.toString, out$ = typeof exports != 'undefined' && exports || this;
