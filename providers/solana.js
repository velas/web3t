    ...
    return getTxData(network, signature, function (err, data) {
      ...
      if (err == null && data != null) {
        ...
        type = (function () {
          ...
          switch (false) {
            case ((ref$ = instructions[1]) != null
              ? (ref1$ = ref$.parsed) != null
                ? ref1$.type
                : void 8
              : void 8) !== 'swapNativeToEvm':
              return 'swapNativeToEvm';
            case instructions[0].programId !==
              '11111111111111111111111111111111':
              return 'buy';
            default:
              return (ref2$ = instructions[0]) != null
                ? (ref3$ = ref2$.parsed) != null
                  ? ref3$.type
                  : void 8
                : void 8;
          }
        ...
        try {
          ...
          if (type === 'evmTransaction') {
            (ref$ = instructions[0].parsed.info.transaction),
              (from = ref$.from),
              (to = ref$.to),
              (value = ref$.value),
              (hash = ref$.hash);
            ...
            hash =
              (ref$ =
                transaction != null
                  ? (ref2$ = transaction.signatures) != null
                    ? ref2$[0]
                    : void 8
                  : void 8) != null
                ? ref$
          ...
          if (type === 'withdraw') {
            sender =
              (ref$ = instructions[0].parsed.info.stakeAccount) != null
                ? ref$
          ...
          if (type == null) {
            ...
            hash = transaction.signatures[0];
            amount =
              (ref$ = getSentAmount(txData)[receiver]) != null ? ref$ : 0;
          }
        } catch (e$) {
          e = e$;
        ...
        isStake =
          (ref$ =
            (ref3$ = instructions[0]) != null
              ? (ref4$ = ref3$.parsed) != null
                ? ref4$.type
                : void 8
              : void 8) === 'stake' ||
          ref$ === 'createAccountWithSeed' ||
          ref$ === 'delegate' ||
          ref$ === 'deactivate';
        try {
          txType = (function () {
