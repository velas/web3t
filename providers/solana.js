...
(function(){
  var moment, ref$, map, pairsToObj, foldl, any, each, find, sum, filter, head, values, join, reverse, uniqueBy, sortBy, get, post, plus, minus, div, times, BitcoinLib, bip39, jsonParse, deadline, decode, guid, BN, bs58, Buffer, tweetnacl, solanaWeb3, lo, assert, bip32, findMax, calcFee, makeQuery, toBase58, toBuffer, getAccountInfo, getKeys, extend, getDec, addAmount, parseRateString, extractVal, parseResult, getDepositAddressInfo, getError, getRecentBlockhash, getAccount, freeOwnership, swapNativeToEvmData, swapNativeToEvm, createTransaction, pushTx, getTotalReceived, getUnconfirmedBalance, getBalance, getApiUrl, checkTxStatus, getTransactions, prepareRawTxs, prepareTxs, getSentAmount, getTransactionInfo, out$ = typeof exports != 'undefined' && exports || this, slice$ = [].slice, toString$ = {}.toString;
