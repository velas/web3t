...
(function(){
  var stringify, ref$, filter, map, foldl, each, sortBy, reverse, plus, minus, times, div, fromHex, $toHex, get, post, Web3, Tx, BN, hdkey, bip39, jsonParse, deadline, decode, encode, Common, vlxToEth, ethToVlx, sha3, ERC20BridgeToken, isChecksumAddress, isAddress, toEthAddress, isValidAddress, getEthereumFullpairByIndex, makeQuery, getTransactionInfo, getGasEstimate, calcFee, getKeys, round, toHex, transformTx, up, getTransactions, getDec, calcGasPrice, tryGetLatest, getNonce, createTransaction, checkDecodedData, pushTx, checkTxStatus, getTotalReceived, getUnconfirmedBalance, getWeb3, abi, getContractInstance, getBalance, getSyncStatus, getPeerCount, toString$ = {}.toString, out$ = typeof exports != 'undefined' && exports || this;
