...
module.exports = (config, cb)->
   def = { eth, insight, erc20, omni, velas2, velas_evm, bitcore, solana, bnb, velas_busd, busd, huobi, velas_huobi, velas_usdt, velas_eth, eth_legacy, usdt_erc20_legacy, usdc, vlx_usdc, bsc_vlx }
